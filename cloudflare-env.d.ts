/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 963c39cd429fb2b9b43b1f87449dad8f)
// Runtime types generated with workerd@1.20260617.1 2026-06-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	FOLDERS_CACHE: KVNamespace;
	IMAGENES_BUCKET: R2Bucket;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "NEXT_PUBLIC_CLERK_SIGN_IN_URL" | "BASE_PREFIX">> {}
}
